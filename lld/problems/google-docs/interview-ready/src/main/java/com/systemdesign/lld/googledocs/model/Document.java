...
/*
 * DESIGN INTENT:
 * Aggregate Root in Domain-Driven Design / Composite Pattern root.
 * Manages document metadata, permissions, revision sequencing, and an ordered list of Paragraphs.
 * Encapsulates global character offset to paragraph mappings.
 */
public class Document implements DocumentElement {
    ...
    public Document(String id, String title, String ownerId) {
        ...
        // Default with one empty paragraph
    ...
    /*
     * Inserts text at document-level character offset.
     * Maps global offset to the corresponding paragraph.
     */
    public void insert(int position, String text, TextStyle style) {
        ...
        // Handle insertion into paragraphs
        int currentOffset = 0;
        for (int i = 0; i < paragraphs.size(); i++) {
    ...
    /*
     * Deletes characters across paragraphs starting at global character offset.
     */
    ...
    /*
     * Formats characters across paragraphs.
     */
