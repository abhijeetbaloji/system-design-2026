...
/*
 * Design Intent:
 * Cart encapsulates customer cart state and strictly enforces the single-restaurant rule.
 * Attempting to add an item from a different restaurant throws RestaurantMismatchException.
 * When the cart becomes empty, restaurantId resets to null, allowing items from another restaurant.
 */
public class Cart {
